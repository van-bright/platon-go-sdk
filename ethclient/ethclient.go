...
func (ec *Client) BalanceAt(ctx context.Context, account string, option interface{}) (*big.Int, error) {
	...
	err := ec.c.CallContext(ctx, &result, "platon_getBalance", account, option)
...
func (ec *Client) StorageAt(ctx context.Context, account common.Address, key common.Hash, option interface{}) ([]byte, error) {
	...
	err := ec.c.CallContext(ctx, &result, "platon_getStorageAt", account, key, option)
	return result, err
}
...
func (ec *Client) NonceAt(ctx context.Context, account string, option interface{}) (uint64, error) {
	...
	err := ec.c.CallContext(ctx, &result, "platon_getTransactionCount", account, option)
...
func (ec *Client) TransactionCountByNumber(ctx context.Context, option interface{}) (uint, error) {
	var num hexutil.Uint
	err := ec.c.CallContext(ctx, &num, "platon_getBlockTransactionCountByNumber", option)
	return uint(num), err
}
...
func (ec *Client) CallContract(ctx context.Context, msg platon.CallMsg, option interface{}) ([]byte, error) {
	...
	err := ec.c.CallContext(ctx, &hex, "platon_call", toCallArg(msg), option)
	if err != nil {
		return nil, err
	}
	return hex, nil
...
func (ec *Client) Accounts(ctx context.Context) ([]string, error) {
	var accounts []string
	if err := ec.c.CallContext(ctx, &accounts, "platon_accounts"); err != nil {
		return []string{}, err
	}
	return accounts, nil
}
...
func (ec *Client) TransactionByBlockNumberAndIndex(ctx context.Context, option interface{}, index uint) (*types.Transaction, error) {
	var json *rpcTransaction
	err := ec.c.CallContext(ctx, &json, "platon_getTransactionByBlockNumberAndIndex", option, hexutil.Uint64(index))
	if err == nil {
		if json == nil {
			return nil, platon.NotFound
		} else if _, r, _ := json.tx.RawSignatureValues(); r == nil {
...
func (ec *Client) Sign(ctx context.Context, req *platon.SignReq) (string, error) {
	var signHash string
	if err := ec.c.CallContext(ctx, &signHash, "platon_sign", req.Signer, req.Data); err != nil {
		return "", err
	}
	return signHash, nil
}
...
func (ec *Client) Evidences(ctx context.Context) (string, error) {
	var evidence string
	if err := ec.c.CallContext(ctx, &evidence, "platon_evidences"); err != nil {
		return "", err
	}
	return evidence, nil
}
